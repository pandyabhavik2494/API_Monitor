...
import java.net.*; 
import java.util.*;
class ClientB extends TimerTask {
	private String apiURL;
	private String APIName;
	private String startTime;
	private String endTime;
	ClientB( String data,String name,String sTime, String eTime) {
		apiURL = data;
		APIName = name;
		startTime = sTime;
		endTime = eTime;
	...
	public static void main(String[] args) {
		...
		String startTimeAPI_1= null,startTimeAPI_2= null,startTimeAPI_3= null,endTimeAPI_1= null,endTimeAPI_2= null,endTimeAPI_3 = null;
				...
				if(chkAPI1){
					Timer t1 = new Timer();
					t1.schedule(new ClientB("http://services.groupkt.com/country/get","API_1",startTimeAPI_1,endTimeAPI_1), 0, poll1*1000);
				}
				if(chkAPI2){
					Timer t2 = new Timer();
					t2.schedule(new ClientB("http://services.groupkt.com/state/get","API_2",startTimeAPI_2,endTimeAPI_2), 0, poll2*1000);
				}
				if(chkAPI3){
					Timer t3 = new Timer();
					t3.schedule(new ClientB("https://jsonplaceholder.typicode.com/todos/1","API_3",startTimeAPI_3,endTimeAPI_3), 0, poll3*1000);
				}
	}
}